...
DATA = {
  ...
  :ceos => [
    ["Elon Musk", "1971", 18900000000],
    ["Clark Valberg", "1978", 500000000],
    ["Steve Jobs", "1955", 19000000000]
  ],
  :problem_keys =>
    ["name", "description", "year_solved", "company_id"],
  :problems => [
    ["Cars That Run On Sustainable Energy", "Create compelling electric vehicles for an affordable price", "2008", 1],
    ["Get design feedback from non technical people ", "Create a platform which allows creators to get feedback from non-technical people, clients and alike", "2011", 2]
  ],
  :technology_keys =>
    ["name", "description", "year", "company_id"],
  :technology_breakthroughs => [
    ["Affordable and reliable electric battery", "Created affordable and reliable electric batteries that can be used in cars", "2008", 1],
    ["Self landing Rockets", "Made rocket travel cheaper by landing them and recycling them fro future flights.", "2017", 3]
  ]
}
